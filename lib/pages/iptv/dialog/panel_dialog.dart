...
import 'package:tivi/pages/iptv/dialog/controller/panel_dialog_controller.dart';
...
class PanelDialog extends GetView<PanelDialogController> {
  ...
  Widget _buildTopLeft(BuildContext context) {
    return  Positioned( top: 20.w,left: 20.w,child: SizedBox(height: 80.w,child: Text('Default Live Source',style: TextStyle(fontSize: 60.sp,color: Theme.of(context).colorScheme.onSurface))));
  }
