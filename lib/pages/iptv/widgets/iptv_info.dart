...
import 'package:tivi/pages/iptv/index.dart';
    ...
    return Row(
      ...
      children: [
        ...
        Obx(
            ...
            child: Text(
              'Sedang Ditonton：${iptvController.currentIptvProgrammes.current.value.isNotEmpty ? iptvController.currentIptvProgrammes.current.value : 'Tidak Ada'}',
              style: TextStyle(
        ...
        Obx(
            ...
            constraints: BoxConstraints(maxWidth: epgShowFull ? 1.sw : 500.w),
            child: Text(
              'Tonton Nanti：${iptvController.currentIptvProgrammes.next.value.isNotEmpty ? iptvController.currentIptvProgrammes.next.value : 'Tidak Ada'}',
              style: TextStyle(
                color: Theme.of(context).colorScheme.onSurface.withOpacity(0.8),
                fontSize: 30.sp,
              ),
